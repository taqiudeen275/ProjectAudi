...
export const metadata: Metadata = {
  title: "Workspace · AudiLink Studio",
  description: "A focused preview of the AudiLink creator workspace.",
...
export default function StudioPage() {
  return <StudioDashboard createActions={createActions} projects={projects} jobs={jobs} />;
}
